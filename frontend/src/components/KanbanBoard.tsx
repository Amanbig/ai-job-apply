        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-slate-950 border border-slate-800 rounded-lg pl-9 pr-3.5 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500 w-64 transition"
            />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {STAGES.map((stage) => {
          ...
          return (
            <div
              key={stage.id}
              className="flex flex-col bg-slate-900/40 rounded-xl border border-slate-800 overflow-hidden min-h-[600px] shadow-sm hover:border-slate-750 transition"
            >
              {/* Stage Header */}
              ...
              <div className="p-3 space-y-3 flex-1 overflow-y-auto">
                {stageApps.length === 0 ? (
                  <div className="text-center py-14 text-xs text-slate-500 border border-dashed border-slate-800/80 rounded-xl space-y-2">
